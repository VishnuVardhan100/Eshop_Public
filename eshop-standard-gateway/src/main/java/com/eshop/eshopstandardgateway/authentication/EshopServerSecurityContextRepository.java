...
/**
 * ServerSecurityContextRepository Implementation
 */

@Component
public class EshopServerSecurityContextRepository implements ServerSecurityContextRepository {
	...
	public Mono<SecurityContext> load(ServerWebExchange exchange) {
        return Mono.justOrEmpty(exchange.getRequest().getHeaders().getFirst(HttpHeaders.AUTHORIZATION))
                ...
                .flatMap(authHeader -> {
                    ...
                    return this.eshopReactiveAuthenticationManager.authenticate(auth).map(SecurityContextImpl::new);
                });
	}
