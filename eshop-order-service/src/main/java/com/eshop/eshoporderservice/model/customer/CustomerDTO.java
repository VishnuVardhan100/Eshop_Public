package com.eshop.eshoporderservice.model.customer;
...
public class CustomerDTO {
	...
	public CustomerDTO(long customerID,
			...
			@NotNull(message = "Mobile Number cannot be blank") @Pattern(regexp = "^[6-9]{1}[0-9]{9}$", message = "Must start with 6,7,8 or 9 and be 10 digits long") @Digits(fraction = 0, integer = 10) String customerMobileNumber,
